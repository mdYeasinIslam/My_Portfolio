...
export const Education = () => {
  return (
      <section className="py-10 lg:py-0 bg-gray-900">
          <div className="container mx-auto flex flex-col md:flex-row  text-white ">
            <div className="border w-full h-full my-auto  mx-auto border-gray-900 shadow-2xl shadow-slate-800 p-3  space-y-3 ">
                  ...
                  <h1 className="text-2xl md:text-3xl text-slate-300 font-medium ">Education B. Sc in Computer Science & Engineering (CSE)</h1>
                  ...
                  <p>I am at Studying B.Sc in Computer Science and Engineering(CSE) from Institute of Science Trade and Technology. Dhaka, Bangladesh</p>
           </div>  
