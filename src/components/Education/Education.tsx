...
export const Education = () => {
  return (
    <section
      id="Education"
      className="py-10 lg:py-20 bg-green-100 text-black"
    >
      <div className="md:container mx-auto flex flex-col-reverse md:flex-row  text-black items-center px-5 md:px-3">
