              ...
              <div className="flex items-center space-x-6 animate-fade-in-up delay-500">
                ...
                <Link to="Contact">
                  <Button
                    ...
                    className="md:!text-lg !normal-case !rounded-lg !shadow-none hover:!bg-black/50  !transition-all !duration-300 border !border-[--primary-color-700]"
                  >
                    Hire me
                  </Button>
                </Link>
                <Button
                  ...
                  onClick={() => {
                    const link = document.createElement("a");
                    link.href =
                      "/Mohammad Yeasin -Frontend developer(Resume).pdf"; // File location in the public folder
                    link.download =
                      "Mohammad Yeasin -Frontend developer(Resume).pdf"; // Filename when downloading
                    link.click();
                  }}
