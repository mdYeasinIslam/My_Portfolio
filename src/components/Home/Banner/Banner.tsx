...
export const Banner = () => {
  return (
    <section id="banner" className="pt-14 bg-gradient-to-l from-black to-gray-900 ">
        <div className="container mx-auto h-full lg:h-[34rem] flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:gap-0 relative space-y-10 py-10 md:py-0">
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              <p className="flex justify-center items-center md:justify-start gap-2 lg:gap-5">
                                  ...
                                  <Link href='https://github.com/mdYeasinIslam'><FaGithub className="w-6 h-6" /></Link>
                                  <Link href="https://www.linkedin.com/in/mohammad-yeasin-islam/"><FaLinkedin className="w-6 h-6"/></Link>
                                    <Link href="https://www.facebook.com/profile.php?id=100011183114419"><FaFacebook className="w-6 h-6" /></Link>
                                    <Link href="https://x.com/home?lang=en&mx=2"><FaTwitter className="w-6 h-6" /></Link>
                                </p>
                            </div>
                      </div>
                      <div>
